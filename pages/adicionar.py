...
with st.form("form_adicionar"):
    nome = st.text_input("",placeholder="Nome do Produto")
    quantidade = st.number_input("Quantidade em Kg kilos / L litros.",placeholder="Quantidade em Kg kilos / L litros." ,min_value=0, step=1)
